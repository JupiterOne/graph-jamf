import { createComputerConfigurationRelationships } from "./ComputerConfigurationRelationshipConverter";

test("convert computer configuration relationships", () => {
  const computers: any[] = [
    {
      general: {
        id: 1,
  ...
  expect(createComputerConfigurationRelationships(computers)).toEqual([
    {
      _class: "USES",
      _fromEntityKey: "user_endpoint_1",
      _key: "user_endpoint_1_uses_jamf_configuration_profile_1",
      _toEntityKey: "jamf_configuration_profile_1",
      _type: "user_endpoint_uses_jamf_configuration_profile",
    },
  ]);
});
